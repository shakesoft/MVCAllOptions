...
```
127.0.0.1 mvcalloptions-local-web
127.0.0.1 mvcalloptions-local-webgateway
127.0.0.1 mvcalloptions-local-authserver
```
...
Now, you can browse the URL: `https://mvcalloptions-local-web`
