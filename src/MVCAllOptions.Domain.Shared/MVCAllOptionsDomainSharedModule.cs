...
public class MVCAllOptionsDomainSharedModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<MVCAllOptionsDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<MVCAllOptionsResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/MVCAllOptions");

            options.DefaultResourceType = typeof(MVCAllOptionsResource);
        ...
        {
            options.MapCodeNamespace("MVCAllOptions", typeof(MVCAllOptionsResource));
        });
    }
}
