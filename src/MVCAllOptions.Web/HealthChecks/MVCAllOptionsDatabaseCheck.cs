...
public class MVCAllOptionsDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public MVCAllOptionsDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
